...
class EdgeEnum(nn.Module):
    ...
    def forward(self, image_feats, feat_mask, corner_outputs, edge_coords, edge_masks, gt_values, corner_nums,
                max_candidates, do_inference=False, get_hs=False):
        ...
        return self.transformer(srcs, masks, all_pos, edge_inputs, edge_center, gt_values,
                                edge_masks, corner_nums, max_candidates, do_inference, get_hs)
